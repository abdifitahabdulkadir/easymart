  ...
  return (
    <div className="grid h-[7rem] w-full grid-cols-4 place-content-center gap-x-2 rounded-[4px] border px-1 py-8 shadow-md shadow-gray-100">
      ...
      <div className="w-full">
        <form action="" className="relative h-[44px] rounded-[4px]">
          <input
            type="text"
            placeholder="01"
            max={10}
          ...
          />
          <RxCaretUp className="absolute right-1 top-1 scale-[1.4] cursor-pointer transition-colors duration-200 hover:text-teritiaryOrangeColor" />
          <RxCaretDown className="absolute bottom-1 right-1 scale-[1.4] cursor-pointer transition-colors duration-200 hover:text-teritiaryOrangeColor" />
        </form>
      </div>
